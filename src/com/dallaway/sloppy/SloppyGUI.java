...
public class SloppyGUI extends javax.swing.JFrame implements UserInterface, HyperlinkListener
{
    ...
    private boolean debug = false;    // GUI resources:
    ...
    public SloppyGUI(final Configuration conf)
    {
        ...
        {
            9.6f, 14.4f, 28.8f, 56f, 128f, 256f, 512f
        };
    ...
    private String getAboutText()
    {
        ...
        append(about, "Java", new String[]
                {
                    "java.version", "java.vendor"
                }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        append(about, "Machine", new String[]
                {
                    "os.name", "os.version", "os.arch"
                }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        append(about, "Web Start", new String[]
                {
                    "javawebstart.version", "jnlpx.home", "jnlpx.jvm"
                }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        append(about, "VM", new String[]
                {
                    "java.vm.name", "java.vm.version", "java.vm.vendor"
                }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        append(about, "Proxy:", new String[]
                {
                    "proxyHost", "proxyPort"
                }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    private boolean updateDestination()
    {
        ...
        URL destination = Util.clean(url);
